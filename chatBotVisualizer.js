...
function showTypingIndicator() {
    ...
    typingIndicator.innerHTML = `<strong>Project Babel:</strong> <em>Typing...</em>`;
...
function sendMessage() {
    ...
    setTimeout(() => {
        ...
        appendMessage('Project Babel', botMessage);
...
function generateResponse(userMessage) {
    ...
    // Boundary for inappropriate questions
        ...
        return "Project Babel will not respond to inappropriate language.";
    }
    }
